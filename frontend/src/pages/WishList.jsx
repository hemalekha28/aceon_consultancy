      ...
      <div className="container" style={{ padding: '2rem 0', minHeight: '60vh' }}>
        <div className="card" style={{
          ...
          <div style={{
            ...
            boxShadow: '0 8px 20px rgba(95, 114, 189, 0.3)'
          }}>
  ...
  return (
    <div className="container" style={{ padding: '2rem 0' }}>
      ...
      <div style={{
        ...
        marginBottom: '2rem',
        color: 'white',
        boxShadow: '0 10px 25px rgba(95, 114, 189, 0.3)',
        position: 'relative',
        overflow: 'hidden'
      }}>
              ...
              <div className="card-body">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  <button
                    ...
                    style={{
                      background: product.stock ? 'var(--gradient-blue-indigo)' : '#e5e7eb',
                      border: 'none',
                  ...
                  <div style={{ display: 'flex', gap: '0.5rem' }}>
                    <button
                      ...
                      style={{
                        flex: 1,
                        background: product.stock ? 'var(--gradient-blue-light)' : '#e5e7eb',
                        border: 'none',
                        color: product.stock ? 'white' : '#9ca3af',
                        padding: '0.75rem 1rem',
                        borderRadius: '10px',
